    ...
    ‚ *
    ‚ *  NOMBRE.......: ERRNO_H
    ‚ *  DESCRIPCION..: Definiciones de los códigos de error de las
    ‚ *                 bibliotecas de funciones de C junto con los
    ‚ *                 protipos de las funciones para manejarlos.
    ‚ *
    ‚ *    Publicado originalmente por Scott Klement en:
    ‚ *      RPG e IFS: Introducción a los archivos continuos
    ‚ *      HELP400, N. 72 (Marzo 2005)
    ‚ *      Suplemento técnico del número 152 de ServerNEWS
    ‚ *
    ‚ *  Programador..: Scott Klement
    ‚ *  Fecha........:
    ‚ *
    ‚ *  Historia:
    ‚ *
    ...
    ‚ *  Notas:
    ‚ *
    ‚ *  - Para enlazar con las funciones de C es necesario especificar
    ‚ *    en el programa el directorio de enlace QC2LE.
    ‚ *
